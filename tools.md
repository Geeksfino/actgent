...
## Example: Calculator Tool By Extending Tool Class
...
```
## Example: Calculator Tool Constructed Via The ToolBuilder class
A tool can also be conveniently constructed with a builder. 

```TypeScript
import { z } from "zod";
import { DynamicTool, StringOutput } from "./Tool";
